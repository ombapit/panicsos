	...
	<div class="row">
        <div class="starter-template col-sm-2 col-md-2 col-lg-2">
            <div class="list-group">
              ...
              <a href="{php}echo base_url();{/php}log/alarm_log" class="list-group-item active">Alarm Log</a>
            </div>
        </div>
        <div class="starter-template col-sm-10 col-md-10 col-lg-10">
            <div class="panel panel-default">
              <div class="panel-heading">Alarm Log</div>
                                    ...
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Hp</th>
                                                <th>Koordinat</th>
                                                <th>Kondisi Tombol</th>
                                                <th>Tanggal dibuat</th>
                                            </tr>
                                            <tr class="second">
                                                <td>
                                                    <label class="input">
                                                        <input type="text" name="unik_id" value="Filter Device Id" class="search_init">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="input">
                                                        <input type="text" name="jenis_laporan" value="Filter Jenis Laporan" class="search_init">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="input">
                                                ...
                                                <td>
                                                    <label class="input">
                                                        <input type="text" name="koordinat" value="Filter Koordinat" class="search_init" style="display: none">
                                                    </label>	
                                                </td>
                                                <td>
                                                    <label class="input">
                                                        <input type="text" name="tombol_status" value="Filter Tombol Status" class="search_init">
                                                    </label>	
                                                </td>
                                                <td>
                                                    <label class="input">
...
<script type="text/javascript">
	function runDataTables() {
		...
		var oTable = $('#datatable_fixed_column').dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": base_url + 'log/alarm_log/table_list',
