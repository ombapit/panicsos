...
class MY_Parser extends CI_Parser {
    ...
    */
    public function parse($template, $data = array(), $return = FALSE, $caching = TRUE)
    {
        ...
        if (!empty($data))
        {
            ...
            {
                $this->CI->smartybc->assign($key, $val);
            }
        }
        
        // Get our template data as a string
        $template_string = $this->CI->smartybc->fetch($template);
    ...
    */
    ...
    {
        return $this->CI->smartybc->fetch('string:'.$template, $data);
    }
